      ...
      <div className="relative z-10 h-full flex flex-col justify-between px-4 sm:px-8 lg:px-16 pt-3 sm:pt-14 lg:pt-20 pb-3 sm:pb-8 lg:pb-12 box-border overflow-hidden">
        ...
        >
          ...
          <div className="relative pt-1">
            {/* Timeline Section Header with Minimal Link */}
            <div className="flex items-center justify-between mb-2">
              ...
              <Link
                href="/journey"
                className="inline-flex items-center gap-1.5 text-xs font-mono text-white/80 hover:text-white transition-colors group"
              >
                <Compass className="w-3.5 h-3.5 text-[#C83228D9] group-hover:rotate-45 transition-transform duration-300" />
                <span className="underline underline-offset-4 decoration-white/20 group-hover:decoration-[#C83228D9]">Explore Full Learning Journey</span>
                <ArrowRight className="w-3.5 h-3.5 text-white/50 group-hover:text-white group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>

            {/* Horizontal subtle guide line */}
            <div className="hidden sm:block absolute top-[35px] lg:top-[37px] left-0 right-0 h-[1px] bg-gradient-to-r from-white/15 via-[#C83228]/45 to-white/15" />
