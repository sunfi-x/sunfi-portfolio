  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-between px-4 sm:px-8 lg:px-16 pt-3 sm:pt-14 lg:pt-20 pb-3 sm:pb-8 lg:pb-12 box-border overflow-hidden">
        {/* ── TOP: Section Label & My Learning Journey Link ──────────────── */}
        <div className="flex justify-between items-center shrink-0 w-full">
          <Link
            href="/journey"
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.06] hover:bg-[#C83228D9] border border-white/15 hover:border-[#C83228D9] text-white text-[11px] font-mono font-semibold tracking-wider uppercase transition-all duration-300 shadow-sm hover:shadow-[0_0_20px_rgba(200,50,40,0.5)] group"
          >
            <Compass className="w-3.5 h-3.5 text-[#C83228D9] group-hover:text-white transition-colors" />
        ...
        >
          ...
          {/* 3. Personal Philosophy Quote Block & Learning Journey Link */}
          <div className="pt-1 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <blockquote
              style={{
                margin: 0,
                fontFamily: "'Space Grotesk', sans-serif",
                fontSize: "clamp(14px, 1.85vw, 24px)",
                fontWeight: 700,
                lineHeight: 1.3,
            ...
            <Link
              href="/journey"
              className="shrink-0 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#C83228D9]/15 hover:bg-[#C83228D9] border border-[#C83228D9]/40 hover:border-[#C83228D9] text-white text-xs font-mono font-semibold tracking-wide transition-all duration-300 shadow-[0_0_15px_rgba(200,50,40,0.2)] hover:shadow-[0_0_25px_rgba(200,50,40,0.6)] group"
            >
              <Compass className="w-4 h-4 text-[#C83228D9] group-hover:text-white transition-colors" />
