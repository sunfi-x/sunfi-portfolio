        ...
        {PLATFORMS.map((social, index) => {
          ...
          return (
            <motion.a
              ...
              title={social.name === "Discord" ? "Discord: sunfi_x" : social.name}
              ...
              className={cn(
                "group relative flex items-center justify-center w-11 h-11 rounded-xl sm:rounded-full",
            ...
            >
              ...
              <IconComponent
                className={cn(
                  "w-[22px] h-[22px] text-gray-400 transition-colors duration-300 relative z-10",
                  social.color
                )}
              />
            </motion.a>
